        ...
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            {topAssisters.map((p, idx) => (
              <div key={p.name} className="sports-card p-4 flex items-center gap-3 hover:border-blue-500/30 transition-colors">
        ...
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {topXG.map((p, idx) => {
              ...
              return (
                <div key={p.name} className="sports-card p-5 space-y-3 hover:border-cyan-500/30 transition-colors">
                  <div className="flex items-center gap-2">
                    <CountryFlag country={p.team} size={20} />
